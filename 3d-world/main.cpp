...
int main(int argc, char **argv)
{
    ...
    GLCALL(glUniform3fv(glGetUniformLocation(shader.getShaderId(), "u_point_light.diffuse"), 1, (float *)&pointLightColor));
    GLCALL(glUniform3fv(glGetUniformLocation(shader.getShaderId(), "u_point_light.specular"), 1, (float *)&pointLightColor));
    pointLightColor *= 0.2f;
    GLCALL(glUniform3fv(glGetUniformLocation(shader.getShaderId(), "u_point_light.ambient"), 1, (float *)&pointLightColor));
